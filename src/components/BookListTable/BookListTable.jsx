...
function BookListTable({ books }) {
    const view = async (id) => {
        await axios.get(`https://node56983-chirawat-noderest.proen.app.ruk-com.cloud/books/${id}`)
    ...
    const deleted = async (book) => {
        await axios.delete(`https://node56983-chirawat-noderest.proen.app.ruk-com.cloud/books/${book.id}`)
            .then((resp) => {
                if (resp.status == 200) {
